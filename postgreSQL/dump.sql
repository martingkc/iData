...
\restrict oDAGfjabWtJe4O9pfFdPHkhWbgtPEdesjfUikHpcBEbdvWPwUEeQNf4OJNsFnrh
...
CREATE TABLE production.productmodelproductdescriptionculture (
    productmodelid integer NOT NULL,
    productdescriptionid integer CONSTRAINT productmodelproductdescriptioncul_productdescriptionid_not_null NOT NULL,
    cultureid character(6) NOT NULL,
    modifieddate timestamp without time zone DEFAULT now() NOT NULL
);
...
--
-- Name: department_departmentid_seq; Type: SEQUENCE SET; Schema: humanresources; Owner: postgres
--
...
--
-- Name: jobcandidate_jobcandidateid_seq; Type: SEQUENCE SET; Schema: humanresources; Owner: postgres
--
...
--
-- Name: shift_shiftid_seq; Type: SEQUENCE SET; Schema: humanresources; Owner: postgres
--
...
--
-- Name: vstateprovincecountryregion; Type: MATERIALIZED VIEW DATA; Schema: person; Owner: postgres
--
...
--
-- Name: vproductanddescription; Type: MATERIALIZED VIEW DATA; Schema: production; Owner: postgres
--
...
\unrestrict oDAGfjabWtJe4O9pfFdPHkhWbgtPEdesjfUikHpcBEbdvWPwUEeQNf4OJNsFnrh
